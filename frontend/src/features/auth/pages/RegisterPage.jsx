...
import { Dog, Mail, Lock, User, ArrowRight, Eye, EyeOff } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-surface-950 flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute top-1/3 -right-32 w-96 h-96 bg-accent-600/15 rounded-full blur-[128px]" />
      <div className="absolute bottom-1/3 -left-32 w-96 h-96 bg-primary-600/15 rounded-full blur-[128px]" />
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-surface-200 mt-3 text-sm">Create your account to get started.</p>
        </div>
        ...
        <div className="p-8 rounded-2xl glass">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* Username */}
            <div>
              <label className="block text-sm font-medium text-surface-200 mb-2">Username</label>
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-surface-200/50" />
                <input
                  type="text"
                  name="username"
